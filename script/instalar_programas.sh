...
flatpak install --assumeyes -y -v org.flozz.yoga-image-optimizer com.ktechpit.ultimate-media-downloader io.gitlab.adhami3310.Converter org.inkscape.inkscape org.gimp.GIMP org.blender.blender org.freecadweb.FreeCAD com.prusa3d.PrusaSlicer
flatpak install --assumeyes -y -v com.obsproject.Studio
pipx install bpsrender
...
# Desarollo
sudo apt install -y micro gnupg ruby-full build-essential zlib1g-dev mosquitto-clients ruby-bundler git gitg python3-pip meld software-properties-common apt-transport-https ca-certificates gnupg2 curl build-essential tree libxcb-cursor0
flatpak install --assumeyes -y -v com.visualstudio.code cc.arduino.IDE2 cc.arduino.arduinoide com.felipekinoshita.Wildcard
#pip install pyside6
